...
linelasreduced3d::linelasreduced3d(int *cinte,int cmregparm, long int celemno){
  
  //cout<<"Calling Constructor for Linelasreduced3d"<<endl;
  ...
  shpstrct = new shapestruct(3,3,cinte,8,LINELASREDUCED3D,celemno);
 ...
 // HACK for now - change with a constructor argument 
  ...
  //cout<<"Calling Memalloc from linelasreduced3d.cpp"<<endl;
  
  memalloc();
  
}
//==================================================================
linelasreduced3d::~linelasreduced3d(){
...
//================================================================
void linelasreduced3d::elemstiff(int which_stiffness){
...
//====================================================================
//void linelasreduced3d::calcfunc(){
//  cout<<"calcfunc in linelasreduced3d()"<<endl;
//}
//====================================================================
void linelasreduced3d::elemrhs(){
  ...
  // cout<<"linelasreduced3d.cpp erhs "<<erhs[jj]<<" "<<endl;
  //}
  
}//elemrhs()
//====================================================================
void linelasreduced3d::calcgradient(){
  cout<<"calcgradient in "<<__FILE__;
}
//====================================================================
void linelasreduced3d::getinteg(){
  gauss3d(shpstrct);
}
//====================================================================
void linelasreduced3d::getshape(){
  shape3d(shpstrct);
}
//====================================================================
void linelasreduced3d::printeltype(){
  cout<<endl<<"This is LINELASREDUCED3D"<<endl;
}
//====================================================================
//void linelasreduced3d::memalloc(){

  // inherited
//}
//====================================================================
//void linelasreduced3d::memdealloc(){
  // dealloc memory
//}
//===================================================================
//void linelasreduced3d::setcoord(double cval,int idime,int inode){
...
//}
//====================================================================
//void linelasreduced3d::setprop(double propval,int iprop,int inode){
  // cval = coordinate value
  // inode = local nodenumber
  // idime = dimension
  // Again should, be in base class
...
//}
//===================================================================
//void linelasreduced3d::setideqn(int inode,int idofn,long int eqnno){
...
//}
//==================================================================
//void linelasreduced3d::setidnode(int inode,long int globalnode){
//  assert(inode<shpstrct->numnodes);
//  idnode[inode]= globalnode;
//}
//=================================================================
// void linelasreduced3d::setisbc(int inode,int idofn,int value){
//  assert(inode<shpstrct->numnodes);
//  assert(idofn<dofnatnode[inode]);
//  
...
// }
//==============================================================
// void linelasreduced3d::setdirdata(double ddata,int inode,int idofn){
//   assert(inode<shpstrct->numnodes);
//   assert(idofn<dofnatnode[inode]);
//   
...
// }
//==============================================================
// void linelasreduced3d::settracdata(double tdata,int inode,int idofn){
//  assert(inode<shpstrct->numnodes);
//  assert(idofn<dofnatnode[inode]);
//
...
// }
//=============================================================
void linelasreduced3d::eleminitstrn(){
  ...
  //for(int ii=0;ii<6;ii++){cout<<"in linelasreduced3d.cpp inistrn[ "<<ii<<"]=="<<initstrn[ii]<<endl;  }
...
//=============================================================
void linelasreduced3d::homogenizehassanihinton(){
  zero4D(shpstrct->ndime,shpstrct->ndime,shpstrct->ndime,shpstrct->ndime,this->BASE_EHIJKL);
  double EHTMP_POS[3][3][3][3];
  double EMTMP_NEG[3][3][3][3];
  // interpolate the properties lambda and mu
  int kk = 0;
  int ll = 0;  
  if (  !( ( initstrntype <= 3*(shpstrct->ndime-1) ) && (initstrntype >=0)  ) ){
    cout<<endl<<"INVALID VALUE FOR initstrntype in linelasreduced3d.cpp, initstrntype = "<<initstrntype<<endl;
    exit(1);
  }
  ...
  for( int iinte = 0; iinte < shpstrct->tinte; iinte++){
	...
	//cout<<"first contrib == "<<firstcontrib<<endl;
	//cout<<"second contib == "<<secondcontrib<<endl;
