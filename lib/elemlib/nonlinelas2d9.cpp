...
nonlinelas2d9::nonlinelas2d9(int* cinte,int cnprop, int cmregparm, long int celemno){
  ...
  shpstrct = new shapestruct(2,2,cinte,9,NONLINELAS2D9,celemno);
...
void nonlinelas2d9::elemstiff(int which_stiffness){
...
//=======================================================================
//void nonlinelas2d9::calcfunc(){
//  
///
//}

//=======================================================================
void nonlinelas2d9:: elemrhs(){
...
//=======================================================================
void nonlinelas2d9:: calcgradient(){
  ...
  KK                  = allocvec(this->nprop,KK);
  propgrad            = allocvec(this->nprop,propgrad);
  defgrad             = allocmat(shpstrct->ndime,shpstrct->ndime,defgrad);
  disp                = allocvec(shpstrct->ndime,disp);
  defgrad             = allocmat(shpstrct->ndime,shpstrct->ndime,defgrad);
  gradu               = allocmat(shpstrct->ndime,shpstrct->ndime,gradu);
  ...
  for(int iinte = 0; iinte<shpstrct->tinte; iinte++){
    ...
    for(int iprop = 0;iprop <nprop;iprop++){
      ...
      for(int inode = 0;inode<knodemax;inode++){
	...
	double dotprdprop = pow(vecnorm(this->nprop,propgrad),2.0);
...
//======================================================================
void nonlinelas2d9::getinteg(){
  // get integration points
  gauss2d(shpstrct);
}
//====================================================================
void nonlinelas2d9::getshape(){
  //cout<<"getshape in nonlinelas2d9()"<<endl;
  shape2d9(shpstrct);
}
//======================================================================
void nonlinelas2d9::printeltype(){
  cout <<endl<<"This is NONLINELAS2D9"<<endl;
}
//=====================================================================
//void nonlinelas2d9::memalloc(){
...
//}
//=====================================================================
//void nonlinelas2d9::memdealloc(){
  // dealloc memory

//}

//==============================================================
//void nonlinelas2d9::calcdual(){
//  
//  
//}
//==============================================================
//gvoid nonlinelas2d9::setdualfield(double ddata,int inode,int idofn){}
//===============================================================
//void nonlinelas2d9::calculate_Tmeas_Tprim(){
